...
load("dat_tsne.RData")
load("dat_uc.RData")
load("plot_lisi.RData")
load("phecodes_complete.RData")
load("plot_lisi_raw.RData")
load("set_cols.RData")
load("dat_harm.RData")
load("top10_EN.RData")
load("dat_umap.RData")
...
#pdf("/PHShome/mom41/Clustering/plots_paper/phespecs.pdf", width = 10)
#invisible(createPheSpec_multi(N = 12, Clusters = c("74", "8", "63", "30", "65", "69", "70", "91", "103"), Dat = dat_clust, EM = dat_em, Sets = id_set_match, BG = dat_bg, Tsne = dat_tsne, Top = top10))
#dev.off()

pdf("/PHShome/mom41/Clustering/plots_paper/phespecs_filtered.pdf", width = 10)
invisible(createPheSpec_multi(N = 12, Clusters = c("74", "8", "63", "30", "65", "69", "70", "91", "103"), Dat = dat_clust, EM = dat_em, Sets = id_set_match, BG = dat_bg, Tsne = dat_tsne, Filter = names(excl_codes), Top = top10))
dev.off()
